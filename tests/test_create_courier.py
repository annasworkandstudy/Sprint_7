...
class TestCreateCourier:
    ...
    def test_create_courier_successfull(self):
    ...
    def test_create_duplicate_courier_conflict(self):
        body = GenerateData.generate_courier_login_password()
        first_response = ScooterMethods.create_courier(body)
        assert first_response.status_code == 201, "Первый курьер должен создаться успешно"
